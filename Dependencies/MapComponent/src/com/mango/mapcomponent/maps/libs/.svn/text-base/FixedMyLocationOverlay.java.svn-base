package com.mango.mapcomponent.maps.libs;
...
//    			ontouchGEOPOINT.getLatitudeE6() / 1E6 + "," + 
//    					ontouchGEOPOINT.getLongitudeE6() /1E6 , 
//    					Toast.LENGTH_SHORT).show();
//		
////		myLocationOverlay2 = new FixedMyLocationOverlay(mContext, mapView);
